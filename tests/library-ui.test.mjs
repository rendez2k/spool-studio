...
test("new user can add, edit, mark used and undo without inheriting local owner data", async () => {
  ...
  const context = vm.createContext({
    FilamentColours: require("../out/colour-catalog.js"), SpoolCollection: require("../out/collection-core.js"), FilamentMatcher: require("../out/matcher.js"), FilamentNfc: require("../out/nfc-codec.js"),
